...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<TD height="75" align="right"><div align="right"><!-- NAV TABLE --><table width="275" border="0">
      ...
      <tr>
        <td><div align="right" class="nav"><a href="smart.php" class="nav" onMouseOver="MM_swapImage('blank2','','images/blueGrassTiny.gif',1)" onMouseOut="MM_swapImgRestore()">get
            smart</a></div></td>
        <td><img src="images/blank.gif" name="blank2"  id="blank2"></td>
      </tr>
      <tr>
  ...
  <tr>
    <td valign="middle"><span class="headline1">Street Level Intelligence + Street
        Smart Marketing </span><span class="content1"><br>
Sinergi Media Inc. is a media and marketing savvy group of publishers, consultants
and creative professionals with unparalleled knowledge of the local, grassroots
online and traditional media space.<br>
          <br>
We specialize in providing clear, informed guidance about how and where to reach
your market through smart, efficient, integrated media campaigns.</span></td>
...
<tr>
  ...
  <tr>
    <td colspan="2" valign="bottom"><img src="images/clear.gif" width="2" height="50"><BR>
    <img src="images/wire.gif" width="750" height="100">	</td>
  </tr>
