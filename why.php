...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td height="75"><img src="images/clear.gif" width="475" height="1"></td>
	<TD height="75" align="right"><div align="right"><!-- NAV TABLE --><table width="275" border="0">
      <tr>
        <td width="209"><div align="right"><a href="why.php" class="nav" onMouseOver="MM_swapImage('blank1','','images/blueGrassTiny.gif',1)" onMouseOut="MM_swapImgRestore()">why
            us</a></div></td>
        <td width="56"><img src="images/blank.gif"  name="blank1" id="blank1"></td>
      </tr>
      <tr>
  ...
  <tr>
    <td valign="middle"><span class="headline1">Get The New Media Glue</span><span class="content1"><br>
Start creating unconventional and integrated media campaigns to glue your messaging
    to a targeted local audience.<br>
<br>
Today's media environment is dynamic and fragmented, breaking down our assumptions
and traditional methods of reaching a market.<br>
<br>
Let Sinergi Media demonstrate how to transform this growing challenge to yesterday's
traditional mass media approach into a powerful competitive advantage.</span> </td>
    <td align="right" valign="top"><img src="images/clear.gif" width="2" height="70"><br>
<a href="index.php"><img src="images/logo-16c.gif" alt="logo" width="262" height="112" border="0"></a></td>
  </tr>
...
<tr>
  ...
  <tr>
    <td colspan="2" valign="bottom"><img src="images/clear.gif" width="2" height="50"><BR><img src="images/dandalie.gif" alt="dandeline" width="750" height="100">	</td>
  </tr>
