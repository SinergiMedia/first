...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<TD height="75" align="right"><div align="right"><!-- NAV TABLE --><table width="275" border="0">
      ...
      <tr>
        <td><div align="right" class="nav"><a href="niche.php" class="nav" onMouseOver="MM_swapImage('blank3','','images/blueGrassTiny.gif',1)" onMouseOut="MM_swapImgRestore()"> meet
            the niche</a></div></td>
        <td><img src="images/blank.gif"  name="blank3"  id="blank3"></td>
      </tr>
      <tr>
  ...
  <tr>
    <td valign="middle"><span class="headline1">Custom Fitting Your Niche </span><span class="content1"><br>
As media buyers, we connect your brand with a uniquely integrated, customizable
    network of media companies, both large and small, that provide influence
    among the lifestyles of your target market.<br>
        <br>
As publishers, we work on a daily basis with the types of well-designed and well-written
publications that get read, heard, watched and talked about. Using these relationships,
we promise you maximum exposure and effectiveness for your media budget.</span></td>
...
<tr>
  ...
  <tr>
    <td colspan="2" valign="bottom"><img src="images/clear.gif" width="2" height="50"><BR><img src="images/lamp.gif" width="750" height="100"></td>
  </tr>
